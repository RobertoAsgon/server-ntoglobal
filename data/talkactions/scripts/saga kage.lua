local config = {
--Naruto
[1] = { {lvl = {1, 1000}, look = 1221, eff = 600},
},
-- Sasuke
[2] = { {lvl = {1, 1000}, look = 1434, eff = 443},
},
--Sakura
[3] = { {lvl = {1, 1000}, look = 1434, eff = 5},
},
--Lee
[4] = { {lvl = {1, 1000}, look = 1434, eff = 617},
},
--Neji
[5] = { {lvl = {1, 1000}, look = 1434, eff = 513},
},
--Tenten
[6] = { {lvl = {1, 1000}, look = 1294, eff = 142},
},
--Gaara
[7] = { {lvl = {1, 1000}, look = 1461, eff = 620},
},
--Kiba
[8] = { {lvl = {1, 1000}, look = 1434, eff = 23},
},
--Shikamaru
[9] = { {lvl = {1, 1000}, look = 1434, eff = 197},
},
--Chouji
[10] = { {lvl = {1, 1000}, look = 1434, eff = 593},
},
--Hashirama
[11] = { {lvl = {1, 1000}, look = 1434, eff = 386},
},
--Tobirama
[12] = { {lvl = {1, 1000}, look = 1434, eff = 397},
},
--Hiruzen
[13] = { {lvl = {1, 1000}, look = 1434, eff = 591},
},
--Minato
[14] = { {lvl = {1, 1000}, look = 1434, eff = 589},
},
--Tsunade
[15] = { {lvl = {1, 1000}, look = 1153, eff = 622},
},
--Kakashi
[16] = { {lvl = {1, 1000}, look = 1497, eff = 607},
},
--Madara
[17] = { {lvl = {1, 1000}, look = 1434, eff = 593},
},
--
}
